    ...
    protected function hook_pre_field_addition_to_page($form, $page_no)
    {
        //if (1 == $page_no)
        {
             ...
             */
                ...
                $form->addElement(new Element_Textbox("<b>" . RM_UI_Strings::get('LABEL_USERNAME') . "</b>:", "username", array("value" => "","labelStyle" => $this->form_options->style_label, "style" => $this->form_options->style_textfield, "required" => "1", "placeholder" => RM_UI_Strings::get('LABEL_USERNAME'))));
...
JSHD;
    ...
    protected function get_prepared_data_primary($request)
    {
        ...
        if(isset($request[$this->primary_field_indices['user_email']]))
        {
