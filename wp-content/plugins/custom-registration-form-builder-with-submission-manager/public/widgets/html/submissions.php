...
foreach ($submissions as $index => $submission) {
    ...
    <div class="rm-submission-card rm-white-box rm-rounded-corners">
                        <div class="rm-submission-card-title dbfl rm-accent-bg"><a href="<?php echo get_permalink(get_option('rm_option_front_sub_page_id')).'?submission_id='.$submission_id; ?>"><?php echo $submission->form_name; ?> </a></div>
