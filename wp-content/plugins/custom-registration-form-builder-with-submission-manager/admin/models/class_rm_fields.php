...
class RM_Fields extends RM_Base_Model
{
    ...
    public function __construct()
    {
        ...
        $this->valid_options = array('field_placeholder', 'field_timezone', 'field_max_length', 'field_is_required_range', 'field_is_required_max_range', 'field_is_required_min_range', 'field_is_required_scroll', 'field_default_value', 'field_css_class', 'field_textarea_columns', 'field_textarea_rows', 'field_is_required','field_is_show_asterix', /*'field_is_required_scroll',*/'field_is_read_only', 'field_is_other_option', 'help_text', 'icon', 'tnc_cb_label');
