...
//        RM_jQ("#scroll").hide();
        ...
        switch (field_type) {
           ...
           case 'HTMLP' :
                ...
                break;
            case 'Shortcode' :
                var object = RM_jQ(".rm_input_type, .rm_field_value, #rm_field_show_on-0").not("#rm_field_value_shortcode");
            ...
            case 'Bdate' :
             var object = RM_jQ(".rm_static_field").not(".rm_required, #rm_field_is_required-0, #rm_field_helptext_container");
            ...
            case 'Skype' :
            case 'SoundCloud' :
              var object = RM_jQ(".rm_static_field").not(".rm_required, #rm_field_is_required-0,#rm_field_placeholder, #rm_field_helptext_container");
                break;
            case 'Divider' :
            case 'Spacing' :
                var object = RM_jQ(".rm_static_field").not(".rm_required, #rm_field_is_required-0");
                RM_jQ("#rm_field_icon_sett_container").hide();
                RM_jQ("#rm_field_helptext_container").hide();
                break;
            case 'Time' :
               var object = RM_jQ(".rm_static_field").not(".rm_required, #rm_field_is_required-0, #rm_field_helptext_container");
            ...
            case 'Terms' :
                var object = RM_jQ(".rm_static_field").not(".rm_required, #rm_field_is_required-0, #rm_field_value_terms, #rm_field_helptext_container");
            ...
            case 'File' :
                var object = RM_jQ(".rm_static_field, #rm_field_default_value").not(".rm_required, #rm_field_is_required-0, #rm_field_value_file_types, #rm_field_helptext_container");
            ...
            case 'Map' :
            case 'Address' : 
                var object = RM_jQ(".rm_static_field").not(".rm_required, #rm_field_type_select_dropdown, #rm_field_label, #rm_field_is_required-0, #rm_field_show_on-0, #rm_field_helptext_container");
                RM_jQ("#rm_no_api_notice").show();
                break;

            default :
                var object = RM_jQ(".rm_static_field").not("#rm_field_type_select_dropdown,  #rm_field_helptext_container");
                RM_jQ(".rm_sub_heading").hide();
                RM_jQ("#rm_field_helptext_container").hide();
                RM_jQ("#rm_icon_setting_container").hide();
