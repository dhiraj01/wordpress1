    ...
    public static function get($identifier) {
        ...
        switch ($identifier) {
            ...
            case 'INFO_USERS_SELECTED_FOR_MAIL':
                return __("You have selected <b>%d users</b> as recipients of this message", 'custom-registration-form-builder-with-submission-manager');
            ...
            case 'FIELD_HELP_TEXT_HTMLP':
                return __('A read only paragraph field useful for displaying multiple lines of text inside form between input fields.', 'custom-registration-form-builder-with-submission-manager');
            ...
            case 'ADMIN_MENU_SETTING_FAB_PT':
                 return __("Floating Action Button Setting", 'custom-registration-form-builder-with-submission-manager');
                
            case 'GLOBAL_SETTINGS_FAB':
                 return __("Floating Action Button", 'custom-registration-form-builder-with-submission-manager');
