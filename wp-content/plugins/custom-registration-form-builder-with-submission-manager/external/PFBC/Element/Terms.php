   ...
   public function render()
    {
       ...
       if($this->required_scroll==1)
        { 
            ...
            echo "<div class='rm_terms_checkbox'><input disabled  type='checkbox'", $this->getAttributes(array("default_value", "value")),  " class='rm_check_box'>".$cb_label."</div>";
        
        echo "<div id='rm_terms_textarea' class='rm_terms_textarea'><textarea ", $style ," onscroll='scroll_down_end(this);' readonly  id='rm_terms_area_", $this->_attributes['name'], "' class='rm_terms_area'>";
        ...
        else
        {
             ...
             echo "<div class='rm_terms_checkbox'><input  type='checkbox'", $this->getAttributes(array("default_value", "value")),  " class='rm_check_box'>".$cb_label."</div>";
        
           echo "<div id='rm_terms_textarea' class='rm_terms_textarea'><textarea ", $style ," readonly  id='rm_terms_area_", $this->_attributes['name'], "' class='rm_terms_area'>";
        if (!empty($this->_attributes["default_value"]))
            echo $this->filter($this->_attributes["default_value"]);
        echo "</textarea></div>";  
        }
