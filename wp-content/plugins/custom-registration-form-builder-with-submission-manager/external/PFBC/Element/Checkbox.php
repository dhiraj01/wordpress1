		...
		foreach($this->options as $value => $text) {
			...
			++$count;
                ...
                if(isset($this->_attributes["rm_is_other_option"]) && $this->_attributes["rm_is_other_option"] == 1){                        
                   echo '<li onclick="rm_append_other_option(this)"><input type="checkbox" style="'.$this->getAttribute("style").'">Other</li><li id="rm_appendable_textbox" style="display:none"><input style="'.$this->getAttribute("style").'" type="text" id="rm_textbox_other_option" name="'.$this->getAttribute("style").'" disabled></li>';
                }
                    echo '</ul>';
	}
}
